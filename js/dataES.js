const estructura =
{
    instrucciones: {
        ...
        Cada dominio está dividido en componentes relevantes que son claves para el éxito de los proyectos, sin embargo y según la experiencia y conocimiento de los profesionales que respondan la encuesta, se busca evaluar la proporcionalidad de valor de aporte del componente a la madurez en la gestión de proyectos.",
        intro_estrategia: "El propósito de la encuesta es determinar el nivel de impacto que tiene cada uno de los componentes del dominio de desempeño sobre las dimensiones estratégicas genéricas de una organización. (Rentabilidad, Eficiencia & Productividad, Personas, Clientes)",
        estrategia: "Para cada ítem relevante del dominio de desempeño, elija entre las alternativas (muy bajo, bajo, medio, alto, muy alto)  para determinar según su experiencia y conocimiento, cuál es el impacto que tiene frente a la dimensión estratégica de una organización."
    },
    escala: [
    ...
    estrategia: [
        { id: "E1", nombre:"Crecimiento & Rentabilidad", descripcion:"" },
        { id: "E2", nombre:"Eficiencia & Productividad", descripcion:"" },
        { id: "E3", nombre:"Personas (Motivación y Alto rendimiento)", descripcion:"Desarrollo de las personas en cuanto a conocimiento, liderazgo servicial, autonomía." },
        { id: "E4", nombre:"Cliente (Entrega de valor)", descripcion:"" }
    ],
    dimensiones: [
        { 
            id: "D1", 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"Se pueden observar relaciones de trabajo productivas con los interesados a lo largo de los proyectos." 
                },
                { 
                    id:"M2", 
                    nombre:"Acuerdo de los interesados con los objetivos del proyecto.", 
                    descripcion:"No se observan cambios significativos en los requisitos y alcance del proyecto o producto. (Siempre considerando que los cambios no tienen relación con un cambio de estrategia u otro)." 
                },
                { 
                    id:"M3", 
                    ...
                    descripcion:"Se debe observar que los interesados que son beneficiarios del proyecto brindan apoyo y están satisfechos, y en el caso de tener interesados detractores, estos no ponen en riesgo los resultados del proyecto." 
                }
        ]},
        { 
            id: "D2", 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"Evidencia que los Los miembros del equipo de proyecto confían uno en el otro y colaboran.<br>\
                ...
                { 
                    ...
                    descripcion:"Existe evidencia que los miembros del equipo de proyecto aplican pensamiento crítico y habilidades interpersonales. Los estilos de liderazgo de los miembros del equipo de proyecto son apropiados para el contexto y el entorno del proyecto." 
                }
        ]},
        { 
            id: "D3", 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"El enfoque de desarrollo de los entregables del proyecto (predictivo, híbrido, o adaptativo) resulta el apropiado dado el proyecto y las características organizacionales." 
                },
                { 
                    id:"M8", 
                    ...
                    descripcion:"El trabajo del proyecto desde el lanzamiento hasta el cierre está representado en las fases del proyecto. Las fases incluyen criterios de salida apropiados." 
                },
                { 
                    id:"M9", 
                    ...
                    descripcion:"La cadencia para el desarrollo, prueba e implementación está claramente representada en las fases del ciclo de vida de los proyectos.<br>\
        ...
        { 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"Se observa que los resultados del proyecto en comparación con las líneas base del mismo y otras métricas de medición demuestra que el proyecto está progresando según lo planeado. Las variaciones de desempeño están dentro de los umbrales." 
                },
                { 
                    id:"M11", 
                    nombre:"Existe un enfoque holístico para entregar los resultados del proyecto", 
                    descripcion:"El cronograma de entrega, el financiamiento, la disponibilidad de recursos, las adquisiciones, etc, son coherentes y demuestran que el proyecto está planificado de manera holística, sin brechas ni áreas de desalineación." 
                },
                { 
                    id:"M12", 
                    ...
                    descripcion:"La información inicial sobre entregables y requisitos en comparación con la información obtenida en un punto de avance se muestra sin mayores cambios lo que demuestra una elaboración inicial apropiada.<br>\
                ...
                { 
                    ...
                    descripcion:"Se observa que los tiempos asignados para la planificación como elaboración previa o durante la ejecución de los proyectos son adecuados según las caracteristicas de los proyectos." 
                },
                { 
                    id:"M14", 
                    nombre:"La información de planificación es suficiente para gestionar las expectativas de los interesados", 
                    descripcion:"Se observa la existencia de un plan de gestión de las comunicaciones y la información de los interesados, el cual deja en evidencia una correcta gestión de expectativas de estos últimos." 
                },
                { 
                    id:"M15", 
                    ...
                    descripcion:"En los proyectos se observan listas de trabajo pendiente con una nueva priorización o que deben se ajustados y adaptados a los planes a lo largo de todo el proyecto.<br>\
        ...
        { 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"Existe evidencia que los informes de estado muestran que el trabajo del proyecto es eficiente y efectivo." 
                },
                { 
                    id:"M17", 
                    nombre:"Procesos del proyecto que son apropiados para el proyecto y el entorno", 
                    descripcion:"La evidencia muestra que los procesos del proyecto han sido adaptados para satisfacer las necesidades del proyecto y del entorno del mismo. Existen auditorías de procesos y actividades de aseguramiento de calidad, dejando en evidencia la importancia del cumplimiento y utilización de los procesos de forma efectiva." 
                },
                { 
                    id:"M18", 
                    nombre:"Comunicación e involucramiento adecuados con los interesados", 
                    descripcion:"Se observa que el plan de comunicación del proyecto y los artefactos de comunicación fueron bien planificados y utilizados y se están entregando a los interesados. Existen pocas solicitudes de aclaraciones de información o malentendidos que puedan indicar que las actividades de involucramiento y comunicación no son efectivas." 
                },
                { 
                    id:"M19", 
                    nombre:"Gestión eficiente de los recursos físicos", 
                    descripcion:"Se debe observar que la cantidad de material utilizado, los desechos y la cantidad de trabajo es acorde a una utilización eficiente de los recursos." 
                },
                { 
                    id:"M20", 
                    nombre:"Gestión eficaz de las adquisiciones", 
                    descripcion:"Existe evidencia de auditoría sobre las adquisiciones, la cual demuestra que los procesos utilizados fueron apropiados y suficientes para la adquisición y que el desempeño del contratista está de acuerdo con el plan." 
                },
                { 
                    id:"M21", 
                    nombre:"Manejo efectivo del cambio", 
                    descripcion:"Los proyectos que utilizan un enfoque predictivo tienen un registro de cambios que muestra que los cambios están siendo evaluados de manera holística teniendo en cuenta el alcance, el cronograma, el presupuesto, los recursos, los interesados y los impactos del riesgo. Los proyectos que utilizan un enfoque adaptativo tienen una lista de trabajo pendiente que indica la tasa de logro del alcance y la tasa de adición de nuevo alcance." 
                },
                { 
                    id:"M22", 
                    nombre:"Capacidad mejorada gracias al aprendizaje continuo y a la mejora de los procesos", 
                    descripcion:"Existe evidencia de procesos de analisis retrospectivo y accionables de mejora continua sobre procesos o actividades de los proyectos. Los informes de estado del equipo, muestran una disminución de errores, retrabajos, y mejora en tiempos de entrega de los entregables." 
                }
        ]},
        { 
            id: "D6", 
            ...
            metodos: [
                {
                    ...
                    descripcion:"El plan de negocio y el plan estratégico de la organización, junto con los documentos de autorización del proyecto, muestran que los entregables del proyecto y los objetivos de negocio están alineados." 
                },
                { 
                    id:"M24", 
                    nombre:"Los proyectos materializan los resultados para los que fueron iniciados", 
                    descripcion:"Se observa en la entrega que el caso de negocio y los datos subyacentes se mantuvieron o mejoraron los resultados previstos o esperados." 
                },
                { 
                    id:"M25", 
                    nombre:"Los beneficios del proyecto se obtienen en el plazo en que se planificaron", 
                    descripcion:"El plan de realización de beneficios, el caso de negocio y/o el cronograma indican que las métricas financieras y las entregas programadas se fueron logrando según lo planeado." 
                },
                {
                    id:"M26", 
                    nombre:"El equipo de proyecto tiene una clara comprensión de los requisitos", 
                    descripcion:"En el desarrollo predictivo, pocos cambios en los requisitos iniciales reflejan la comprensión por el equipo. En los proyectos donde los requisitos evolucionan, debe existir evidencia de acciones iterativas que permitan una comprensión clara de los requisitos a medida que avanza el proyecto." 
                },
                { 
                    id:"M27", 
                    nombre:"Los interesados aceptan y están satisfechos con los entregables del proyecto", 
                    descripcion:"En entregas parciales y finales de los proyectos se observa la aplicación de actividades investigativas como entrevistas, la observación y la retroalimentación del usuario final para confirmar el nivel de satisfacción de los interesados. Los niveles de quejas y devoluciones también pueden utilizarse para indicar satisfacción." 
                }
        ]},
        { 
            id: "D7", 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"Existe evidencia de mediciones e informes de auditoría para demostrar que los datos de los proyectos son confiables." 
                },
                { 
                    id:"M29", 
                    nombre:"Datos procesables para facilitar la toma de decisiones", 
                    descripcion:"Se debe ser capaz de obtener datos referentes al desempeño esperado del proyecto en un estado actual o para identificar existencia de variaciones y magnitud de las mismas." 
                },
                { 
                    id:"M30", 
                    nombre:"Acciones oportunas y apropiadas para mantener el desempeño del proyecto bien encaminado", 
                    descripcion:"Las mediciones deben proporcionar indicadores del estado actual y de proyección o pronostico para conducir a que las decisiones y acciones sean oportunas." 
                },
                { 
                    id:"M31", 
                    ...
                    descripcion:"Se observan acciones de revisión de los pronósticos pasados y el desempeño actual para confirmar si se refleja el presente con precisión. La comparación del desempeño real con el desempeño planeado y la evaluación de los documentos de negocio mostrarán la probabilidad de lograr el valor previsto del proyecto." 
                }
        ]},
        { 
            id: "D8", 
            ...
            metodos: [
                { 
                    ...
                    descripcion:"Existe evidencia que el equipo incorpora consideraciones en diversos aspectos de la incertidumbre, riesgo y sus respuestas de acuerdo a la naturaleza del negocio, proyecto, industria etc." 
                },
                { 
                    id:"M33", 
                    nombre:"Exploración proactiva y respuesta a la incertidumbre", 
                    descripcion:"Existe evidencia que el foco a las respuestas o a los riesgos están alineadas con la priorización de las limitaciones del proyecto, como el presupuesto, el cronograma y el desempeño." 
                },
                { 
                    id:"M34", 
                    nombre:"Concientización de la interdependencia de múltiples variables en el proyecto", 
                    descripcion:"Los equipos tienen presente abordar la complejidad, ambigüedad y volatilidad en los proyectos y generar las acciones más apropiadas para ello." 
                },
                { 
                    id:"M35", 
                    nombre:"La capacidad de anticipar amenazas y oportunidades y comprender las consecuencias de los incidentes", 
                    descripcion:"Se observan sistemas robustos para identificar, capturar y responder al riesgo  de forma efectiva y adecuada." 
                },
                { 
                    id:"M36", 
                    nombre:"Entrega de proyectos con poco o ningún impacto negativo procedente de eventos o condiciones imprevistas", 
                    descripcion:"En el caso de apariciones de eventos o condiciones imprevistas, los proyectos aún cumplen las fechas de entrega programadas y la ejecución del presupuesto está dentro del umbral de variación." 
                },
                { 
                    id:"M37", 
                    nombre:"Oportunidades materializadas para mejorar el desempeño y los resultados del proyecto", 
                    descripcion:"Existe evidencia que los equipos cuentan y utilizan mecanismos establecidos para identificar y aprovechar las oportunidades." 
                },
                { 
                    id:"M38", 
                    ...
                    descripcion:"Los equipos toman medidas para prevenir de forma proactiva las amenazas, limitando así el uso de la reserva de costos o tiempos en el cronograma." 
                }
        ]},
    ]
}